...
public class JardinActivity extends AppCompatActivity {
    ImageView portouvert1,portferme1;
    Switch butonswitsh1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras!=null) {
            champ22=(extras.getString("champ7"));
            patron=(extras.getString("user6"));
            user2.append(patron);
        }
        image1 = (ImageButton) findViewById(R.id.home_rl2);
        portouvert1 = (ImageView) findViewById(R.id.portouvert);
        portferme1 = (ImageView) findViewById(R.id.portferme);
        ...
        reff1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String humi= Objects.requireNonNull(dataSnapshot.child(champ22).child("jardin").child("humidité").getValue()).toString();
                String etat= Objects.requireNonNull(dataSnapshot.child(champ22).child("jardin").child("porte").getValue()).toString();
        ...
        butonswitsh1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    portouvert1.setImageResource(R.drawable.portouvert);
                    reff1.child(champ22).child("jardin").child("porte").setValue((1));
                }
                else{
                    portouvert1.setImageResource(R.drawable.portferme);
                    reff1.child(champ22).child("jardin").child("porte").setValue((0));
                }
            }
        });
