...
public class SalonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras!=null) {
            champ22=(extras.getString("champ4"));
            patron=(extras.getString("user3"));
            user2.append(patron);
        }
        ...
        reff1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String etat= Objects.requireNonNull(dataSnapshot.child(champ22).child("salon").child("fenêtre").getValue()).toString();
        ...
        butonswitsh1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ledall1.setImageResource(R.drawable.portouvert);
                    reff1.child(champ22).child("salon").child("fenêtre").setValue((1));
                }
                else{
                    ledall1.setImageResource(R.drawable.portferme);
                    reff1.child(champ22).child("salon").child("fenêtre").setValue((0));
                }
            }
        });
